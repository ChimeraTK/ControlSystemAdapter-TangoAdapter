...
#define BOOST_TEST_MODULE serverTestFaultBrokenAttribute
...
BOOST_AUTO_TEST_CASE(testServerFaultBrokenAttribute) {
  ...
  ts.setOfflineDatabase("testServerFaultWrongAttribute");
