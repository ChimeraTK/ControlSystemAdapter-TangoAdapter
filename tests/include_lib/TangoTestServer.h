...
using TestTypesNoVoid = boost::mpl::list<double, float, int64_t, int32_t, int16_t, int8_t, uint64_t, uint32_t, uint16_t, uint8_t, ChimeraTK::Boolean, std::string>;
using TestTypes = boost::mpl::list<double, float, int64_t, int32_t, int16_t, int8_t, uint64_t, uint32_t, uint16_t, uint8_t, ChimeraTK::Boolean, ChimeraTK::Void, std::string>;


using Type2Tango = boost::mpl::map<
    boost::mpl::pair<double, Tango::DevDouble>,
    boost::mpl::pair<float, Tango::DevFloat>,
    boost::mpl::pair<int64_t, Tango::DevLong64>,
    boost::mpl::pair<int32_t, Tango::DevLong>,
    boost::mpl::pair<int16_t, Tango::DevShort>,
    boost::mpl::pair<int8_t, Tango::DevShort>,
    boost::mpl::pair<uint64_t, Tango::DevULong64>,
    ...
    boost::mpl::pair<ChimeraTK::Void, Tango::DevBoolean>,
